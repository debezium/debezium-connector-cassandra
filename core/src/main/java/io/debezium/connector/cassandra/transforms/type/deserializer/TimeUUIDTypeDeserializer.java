...
public class TimeUUIDTypeDeserializer extends LogicalTypeDeserializer {
    ...
    public TimeUUIDTypeDeserializer(DebeziumTypeDeserializer deserializer, Object abstractType) {
        super(deserializer, ProtocolConstants.DataType.TIMEUUID, abstractType);
    }
