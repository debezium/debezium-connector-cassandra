...
public class SnapshotProcessorTest extends DseConnectorTestBase {
    ...
    public void testSnapshotTable() throws Exception {
        ...
        SnapshotProcessor snapshotProcessor = Mockito.spy(new SnapshotProcessor(context, new DseTypeProvider().getClusterName()));
    ...
    public void testSnapshotModeAlways() throws Exception {
        ...
        SnapshotProcessor snapshotProcessorSpy = Mockito.spy(new SnapshotProcessor(context, new DseTypeProvider().getClusterName()));
