...
public class DseSchemaChangeListener extends AbstractSchemaChangeListener {
    ...
    public DseSchemaChangeListener(String kafkaTopicPrefix,
    ...
    public void onKeyspaceCreated(final KeyspaceMetadata keyspaceMetadata) {
        try {
            org.apache.cassandra.schema.KeyspaceMetadata existingKMD = SchemaManager.instance.getKeyspaceMetadata(keyspaceMetadata.getName().asInternal());
            if (existingKMD != null) {
                return;
            }
            ...
            SchemaManager.instance.load(newKMD);
    ...
    public void onKeyspaceUpdated(final KeyspaceMetadata current, final KeyspaceMetadata previous) {
        try {
            SchemaManager.instance.load(org.apache.cassandra.schema.KeyspaceMetadata.create(
    ...
    public void onTableCreated(com.datastax.oss.driver.api.core.metadata.schema.TableMetadata tableMetadata) {
        ...
        try {
            ...
            final org.apache.cassandra.schema.KeyspaceMetadata current = SchemaManager.instance.getKeyspaceMetadata(metadata.keyspace);
            if (current == null) {
            ...
            SchemaManager.instance.load(transformed);
    ...
    public void onTableDropped(com.datastax.oss.driver.api.core.metadata.schema.TableMetadata tableMetadata) {
        ...
        try {
            ...
            final org.apache.cassandra.schema.KeyspaceMetadata oldKsm = SchemaManager.instance.getKeyspaceMetadata(ksName);
            if (oldKsm == null) {
                LOGGER.warn("KeyspaceMetadata for keyspace {} is not found!", ksName);
                return;
            }

            TableMetadata metadata = SchemaManager.instance.getTableMetadata(TableId.fromUUID(tableMetadata.getId().get()));
            if (metadata == null) {
                LOGGER.warn("Metadata for ColumnFamilyStore for {}.{} is not found!", ksName, tableName);
                return;
            }

            Keyspace instance = SchemaManager.instance.getKeyspaceInstance(metadata.keyspace);
            if (instance == null) {
            ...
            if (cfm.isPresent()) {
                ...
                SchemaManager.instance.load(newKsm);
    ...
    public void onTableUpdated(final com.datastax.oss.driver.api.core.metadata.schema.TableMetadata newTableMetadata,
        ...
        try {
            ...
            org.apache.cassandra.schema.KeyspaceMetadata current = SchemaManager.instance.getKeyspaceMetadata(metadata.keyspace);
            if (current != null) {
                SchemaManager.instance.load(current.withSwappedTable(metadata));
            }
